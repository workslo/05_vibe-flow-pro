...
- [x] Recover `lineage-stage-node.tsx` from `10ed89f` into `src/app/tax-ops-mapper/components/lineage-stage-node.tsx`; adapt imports (shared UI already exists under `@/components`).
